...
object Constants {
    ...
    //Number of lower letters in the alphabet
    const val NUM_LETTERS_LOWER = 26

    //Number of higer letters in the alphabet
    const val NUM_LETTERS_UPPER = 26

    //Number of digits
    const val NUM_DIGITS = 10

    //Number of symbols in standard keyboard
    const val NUM_SYMBOLS = 32
